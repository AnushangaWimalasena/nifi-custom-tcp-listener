 ...
 */
package com.mycompany.processors;
...
public class TestListenTCP {
    ...
    public void testCustomValidate() throws InitializationException {
        runner.setProperty(ListenTCP.PORT, "9900");
        runner.assertValid();
        ...
        runner.assertValid();
        System.out.println("testCustomValidate called successfully\n");
    }
    ...
    public void testListenTCP() throws IOException, InterruptedException {
        ...
        System.out.println("testListenTCP called successfully\n");
    }
    ...
    public void testListenTCPBatching() throws IOException, InterruptedException {
        ...
        System.out.println("testListenTCPBatching called successfully\n");
    }
    ...
    public void testTLSClienAuthRequiredAndClientCertProvided() throws InitializationException, IOException, InterruptedException,
        ...
        System.out.println("testTLSClienAuthRequiredAndClientCertProvided called successfully\n");
    ...
    public void testTLSClienAuthRequiredAndClientCertNotProvided() throws InitializationException, IOException, InterruptedException,
        ...
        try {
            ...
            System.out.println("testTLSClienAuthRequiredAndClientCertNotProvided call successfully\n");
        } catch (Exception e) {
            System.out.println("testTLSClienAuthRequiredAndClientCertProvided call failed\n");
        }
    }
    ...
    public void testTLSClienAuthNoneAndClientCertNotProvided() throws InitializationException, IOException, InterruptedException,
        ...
        System.out.println("testTLSClienAuthNoneAndClientCertNotProvided call successfully\n");
    ...
    protected void runTCP(final List<String> messages, final int expectedTransferred, final SSLContext sslContext)
        ...
        try {
            ...
            Assert.assertTrue("Dispatcher port should be greater than zero.", realPort > 0);
            System.out.println("Port: " + realPort);
            Thread.sleep(500);  // Allow additional time for the dispatcher to initialize
    ...
    private SSLContextService configureProcessorSslContextService() throws InitializationException {
        ...
        runner.setProperty(sslContextService, StandardSSLContextService.TRUSTSTORE_PASSWORD, "newpassword");
        ...
        runner.setProperty(sslContextService, StandardSSLContextService.KEYSTORE_PASSWORD, "newpassword");
